        ...
        <div className=" hidden md:grid grid-cols-2 h-auto   ">
          <div className=" mx-auto max-w-screen-xl col-span-1  flex flex-col md:items-left justify-center space-y-7 ml-5 mt-6">
            <h1 className="text-2xl font-bold">
              Transform your game from anywhere
            </h1>
            <h1 className="text-xl font-normal">
              With online programs and 1:1 coaching, you can get personalized
              insights from me, JLaw, to help transform your game. Online,
              anytime, anywhere.
            </h1>
          </div>
